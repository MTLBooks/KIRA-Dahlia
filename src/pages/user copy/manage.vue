	...
	<div class="container">
		...
		<NSpace align="center" justify="space-between">
			...
			<NFlex align="center" justify="right">
				...
				<NButton @click="getUserInfo()"><template #icon><Icon name="search" /></template>Search</NButton>
			</NFlex>
		</NSpace>
		...
		>
			<br />
			<NAlert type="warning" title="Warning"><div>Proceed with caution when modifying!</div></NAlert>
			<br />
		...
		>
			...
			<template #action>
				...
				<NButton :disabled="currentClearingUserInfo !== userInputClearingUserInfo" :loading="isClearingUserInfo" type="warning" :secondary="true" @click="clearUserInfo()">Confirm Delete</NButton>
			</template>
		</NModal>
		...
		>
			...
			<template #action>
				...
				<NButton :disabled="currentBanUserInfo !== userInputBanUserInfo" :loading="isBanUser" type="warning" :secondary="true" @click="banUser()">Confirm Block</NButton>
			</template>
		</NModal>
