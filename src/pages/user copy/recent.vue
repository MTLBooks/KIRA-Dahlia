		...
		<NSpace align="center" justify="space-between">
			<NCollapse class="mlb-4">
				<NCollapseItem title="Instructions">
					...
					<NP>Click Approve to accept user info changes (enter user's UUID to confirm).<br />After approval, user role returns to regular.</NP>
					<NP>Click Clear to remove user info (enter user's UID to confirm).<br />After clearing, the user info will be removed.</NP>
				</NCollapseItem>
			</NCollapse>
		...
		>
			...
			<div class="mt-4">
				...
				<div class="flex flex-wrap gap-2">
					...
					<span v-if="(userInfoData.label || []).length === 0"><NTag size="small" type="info">No tags</NTag></span>
				</div>
			</div>
